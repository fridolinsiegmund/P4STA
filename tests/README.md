...
```
Note: you must copy the bf-sde-9.13.4.tar.xz file into bf_sde_docker before creating the container if tests for the tofino target should be executed.
...
Note: you must copy the bf-sde-9.13.4.tar.xz file into bf_sde_docker before creating the container
```
./build_docker_images.sh
```
